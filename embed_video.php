    ...
    <script>
      "use strict";
        ...
        angularApp.controller("angularController", ["$scope", "$http", "$interval", "$timeout", function ($scope, $http, $interval, $timeout) {
          ...
          $scope.playlistid_venta = 'PLDPoi9RrXf-Z7_PTjFbQOlQ0UMmATBFV1';
        ...
        angularApp.filter('trustedVideos', ['$sce', function ($sce) {
          return function(video) {
              //console.log(video);
              //console.log(video.snippet.resourceId.videoId);
              return $sce.trustAsResourceUrl("https://www.youtube.com/embed/" + video.snippet.resourceId.videoId + "?list=PLDPoi9RrXf-Z7_PTjFbQOlQ0UMmATBFV1&amp;widgetid=1&amp;enablejsapi=1&amp;autoplay=1&amp;muted=1&amp;controls=0&amp;rel=0&amp;showinfo=0&amp;loop=1&amp;modestbranding=1&amp;iv_load_policy=3");
          };
        }]);        
        ...
        angularApp.filter('trustedAlquileres', ['$sce', function ($sce) {
          return function(video) {
              //console.log(video);
              //console.log(video.snippet.resourceId.videoId);
              return $sce.trustAsResourceUrl("https://www.youtube.com/embed/" + video.snippet.resourceId.videoId + "?list=PLDPoi9RrXf-bVk_FFonF4E1dpOYiR5reo&amp;widgetid=1&amp;enablejsapi=1&amp;autoplay=1&amp;muted=1&amp;controls=0&amp;rel=0&amp;showinfo=0&amp;loop=1&amp;modestbranding=1&amp;iv_load_policy=3");
          };
        }]);
       ...
       /* angularApp.filter('trustedAlquileres', ['$sce', function ($sce) {
          return function(video) {
              //console.log(video);
              //console.log(video.snippet.resourceId.videoId);
              return $sce.trustAsResourceUrl("https://www.youtube.com/embed/" + video.snippet.resourceId.videoId + "?list=PLDPoi9RrXf-bVk_FFonF4E1dpOYiR5reo&rel=0&autoplay=1&loop=1&mute=1");
          };
        }]);*/
  ...
  <body class="vtl" ng-app="angularApp" ng-controller="angularController">
    <div class="screen_video">
      ...
      <div class="list_screen_video" ng-repeat="video in videos_venta.items | limitTo: 1">
        ...
        <iframe ng-src="{{video | trustedVideos}}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
